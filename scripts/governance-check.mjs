 ...
 * **2026-07-27 引き上げ 15823→16028**（実測 15823→15928・+105 字）: #749 の plan.md ゲート機構を
 * `docs/hooks.md` へ実装契約として、CLAUDE.md フック表へ発火条件・正しい対応を同期した（task-4-brief）。
 * ゲートの案内追記は旧予算 15823 を 105 字超過したため、実測 15928 + 100 字バッファで 16028 へ引き上げた。
 */
